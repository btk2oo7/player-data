local REQUIRED_MODULE = require(script.Parent._Index["jsdotlua_react@17.2.1"]["react"])export type Object = REQUIRED_MODULE.Object 
...
export type ElementConfig<T> = REQUIRED_MODULE.ElementConfig<T>
...
export type React_Context<T> = REQUIRED_MODULE.React_Context<T>
export type React_Element<ElementType> = REQUIRED_MODULE.React_Element<ElementType>
